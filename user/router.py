...
def get_me(current_user: User = Depends(get_current_user)):
    return success_response(data=current_user, message="User fetched successfully")
...
def list_users(db: Session = Depends(get_db), current_user: User = Depends(get_current_user)):
    ...
    return success_response(data=users, message="Users available for connection")
...
@router.put("/me/username", response_model=ApiResponse[UserProfileResponse])
def change_username_api(
    ...
    return success_response(data=user, message="Username updated successfully")
...
def change_password_api(
    ...
    return success_response(message="Password updated successfully. Please login again.")
